...
from distill_lib.core.models.config import GlobalConfig

from distill_lib.core.models.llm import enum_factory
...
def write_config(cfg: GlobalConfig):
    from distill_lib.core.config.loader import get_config_path
